...
\begin{table}
	...
	\begin{tabular}{|l | c |}
		Model & Accuracy\\
		\hline
		MobileNetV3Large-Layer[:270] + Soft-Attention & 0.71 \\
		\hline
		MobileNetV3Large-Layer[:266] + Soft-Attention & 0.73 \\
		\hline
		MobileNetV3Large-Layer[:260] + Soft-Attention & 0.77 \\
		\hline
		MobileNetV3Large-Layer[:251] + Soft-Attention & 0.79 \\
		\hline
		MobileNetV3Large-Layer[:246] + Soft-Attention & 0.84 \\
		\hline
		MobileNetV3Large-Layer[:246] + Soft-Attention + Dense(512)& 1 \\
	\end{tabular}
\end{table}
\section{Conclusion}
