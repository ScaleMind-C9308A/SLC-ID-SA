...
The HAM10000 data set\cite{10417} also contain the metadata of patient including gender, age, and the capturing position 
\begin{table}[H]
	\centering
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{Definitions/MainModel - Model Form}
...
After the experiment, the InceptionResNetV2 is chose to compare with the other SOTA models. 
