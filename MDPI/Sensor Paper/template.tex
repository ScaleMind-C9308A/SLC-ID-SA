...
\Author{Viet Dung Nguyen $^{1,\dagger}$\orcidA{}, Ngoc Dung Bui $^{2,\dagger}$\orcidB{} and Khoi Do Hoang $^{3,\dagger}$\orcidC{}}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Dung Viet Nguyen, Ngoc Dung Bui and Khoi Do Hoang}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{Nguyen, D.; Bui, D.; Khoi, D.}
% If this is a Chicago style journal: Lastname, Firstname, Firstname Lastname, and Firstname Lastname.

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)

\address{
$^{1}$ \quad Faculty: Information Technology, University of Transport and Communications, Vietnam \\
$^{2}$ \quad Faculty: Information Technology, University of Transport and Communications, Vietnam\\
$^{3}$ \quad Faculty: Information Technology, University of Transport and Communications, Vietnam}

% Contact information of the corresponding author
\corres{Correspondence: dung.nguyenviet1@hust.edu.vn; Tel.:  +84-9834-443-22 (D.N.)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Conceptualization, D.N. and K.D.; methodology, D.N. and K.D.; software, K.D.; validation, D.N., D.B. and K.D.; formal analysis, D.N. and K.D.; investigation, D.N., D.B. and K.D.; resources, D.N.; data curation, K.D.; writing---original draft preparation, K.D.; writing---review and editing, D.N. and D.B.; visualization, K.D.; supervision, D.N. and D.B.; project administration, D.N. All authors have read and agreed to the published version of the manuscript.}
